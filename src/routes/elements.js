...
export const ConferenceList = Loadable(
  lazy(() => import('../pages/dashboard/ConferenceList'))
);
...
export const FeaturedJournals = Loadable(
  lazy(() => import('../pages/dashboard/FeaturedJournals'))
);
...
export const MasterList = Loadable(
  lazy(() => import('../pages/dashboard/MasterList'))
);
export const MasterDetails = Loadable(
  lazy(() => import('../pages/dashboard/MasterDetails')));
  export const EvaluationList = Loadable(
    lazy(() => import('../pages/dashboard/EvaluationList'))
  );
  export const EvaluationDetails = Loadable(
    lazy(() => import('../pages/dashboard/EvaluationDetails')));
// DASHBOARD: INVOICE
...
// SearchResultsPage
export const SearchResultsPage = Loadable(lazy(() => import('../pages/dashboard/SearchResultsPage')));
...
export const SelectionPage = Loadable(lazy(() => import('../pages/SelectionPage')));
