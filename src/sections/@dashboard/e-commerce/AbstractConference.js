...
// components
import { createAbstract, getAbstractById, updateAbstract } from '../../../controller/abstractconferenceController';
// conferenceName
// ----------------------------------------------------------------------
            ...
            if (isEdit) {
                try {
                    ...
                    if (conference) {
                        ...
                        reset({
                            conferenceName: conference.conferenceName || '',   // changed to conference.journalName
