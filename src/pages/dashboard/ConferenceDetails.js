...
export default function ConferenceDetailsPage() {
  ...
  return (
    <>
      ...
      <Container maxWidth={themeStretch ? false : 'lg'} style={{ backgroundImage: 'url("https://w0.peakpx.com/wallpaper/855/63/HD-wallpaper-light-purple-plain-background-purple.jpg")',  height: 'auto',
          paddingBottom: '50px' }}>
        <CustomBreadcrumbs
