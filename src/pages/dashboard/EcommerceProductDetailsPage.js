  ...
  return (
    <>
      ...
      <Container
        ...
        sx={{
          backgroundImage: 'url("https://w0.peakpx.com/wallpaper/855/63/HD-wallpaper-light-purple-plain-background-purple.jpg")',
          // minHeight: '300px',
          height: 'auto',
          paddingBottom: '50px' // Add padding to avoid content overlap
        }}
      >
        <CustomBreadcrumbs
          ...
          style={{ color: 'white' }}
          links={[
            { name: 'Dashboard', href: '/', style: { color: 'white' } },
            { name: 'Journal', href: '/', style: { color: 'white' } },
            { name: 'Details', href: '/', style: { color: 'white' } },
